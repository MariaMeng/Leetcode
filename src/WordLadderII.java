...
public class WordLadderII {
    ...
    public static void main(String[] args) {
        WordLadderII mySolution = new WordLadderII();
        String beginWord = "hit";
        String endWord = "cog";
        String[] wordlist = {"hot","dot","dog","lot","log","cog"};
        List<String> wordAList = new ArrayList<>();
        Collections.addAll(wordAList, wordlist);
        List<List<String>> list = mySolution.findLadders(beginWord, endWord, wordAList);
